...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader
                .getResource("classpath:/saml/keystore2.jks");
        String storePass = "123456";
        Map<String, String> passwords = new HashMap<String, String>();
        passwords.put("com:vdenotaris:spring:sp", "123456");
        String defaultKey = "com:vdenotaris:spring:sp";
...
//    }
    ...
    public SimpleUrlLogoutSuccessHandler successLogoutHandler() {
        ...
        successLogoutHandler.setDefaultTargetUrl("http://127.0.0.1:8088/home");
